...
import { asyncSetMovieInfo, removeInfo } from "../Store/Actions/MoviesActions";
  ...
  return info ? (
    ...
    >
      ...
      <div className="absolute w-full h-full top-0 left-1/2 -translate-x-1/2 overflow-y-auto  px-[5%]">
        ...
        <div className="px-3 flex gap-[5%] justify-center">
          {/* part-2 left*/}
          ...
          <div className=" basis-3/5">
            ...
            <div className="flex items-center gap-2 my-4">
              ...
              <h5 className="font-medium text-xl leading-tight">
                {(info.detail.runtime / 60).toFixed(2)} hrs.
              </h5>
            </div>
            {info.detail.tagline && (
        ...
        {info.similar.length > 0 && (
          <>
            ...
            <HorizontalScroll data={info.similar} title={"movie"} />
          </>
        )}
        {info.recommendations.length > 0 && (
          <>
            ...
            <HorizontalScroll data={info.recommendations} title={"movie"} />
          </>
        )}
      </div>
      <Outlet />
